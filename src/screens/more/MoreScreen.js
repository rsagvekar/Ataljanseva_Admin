...
const ALL_ITEMS = [
  ...
  },
  {
    ...
    desc: 'Send messages to citizens',
    color: '#d1fae5',
    perm: 'send_bulk_message',
  ...
  },
  {
    ...
    desc: 'Greet voters on special days',
    color: '#fce7f3',
    perm: 'view_birthdays',
    screen: 'Birthdays',
  },
        ...
        <View style={[styles.grid, {gap}]}>
          {visibleItems.map(item => (
            <TouchableOpacity
              ...
              style={[
                styles.card,
                {backgroundColor: item.color, width: cardWidth},
              ]}
